...
class Story:
    def __init__(self):
        self.the_beginning = ("In a cave, you were born and around you there are too many books and the 'Holy Sword' , you have learnt about  each era of this world by reading books....though you dont know, which era are you living. You have learnt how to use the 'Holy Sword'.\nOne day, you were going to read one last book before taking a journey in this vast cave,in this book you found a note:\n'Please save me from the monsters'\n-The Princess. \nYour instinct tells you to save her, and like this you started your journey. ")
        self.step2 = (
            "\nYou are walking in the cave, trying to collect your bravery , you see an enemy ,you gotta walk more to get him and kill him.")
